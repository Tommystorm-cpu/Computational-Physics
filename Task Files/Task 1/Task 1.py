...
m, c = np.polyfit(x, y, 1)   #computes line of best fit in the form y = mx + c
plt.axline(xy1=(0, c), slope=m, color="r", label=f'$ y = {m}x$') #plots line of best fit and assigns gradient as legend
